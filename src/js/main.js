let data = fetch('http://event-archive/')
...
function createHtml(data) {
  ...
  slider.innerHTML = `       
        <div class="slider__current">
          <img src="${data[0].image}" alt="" class="slider__img">
  ...
  data.forEach((el, i) => {
    ...
    <div class="slider__item slider__item-active flex">
            <img src="${el.image}" alt="" class="slider__img">
...
function autoSlide(sliderList, data, tar) { 
  ...
  sliderCurrent.innerHTML = ` <img src="${data[current].image}" alt="" class="slider__img">
                              <div class="slider__info info flex">
                                <div class="">
